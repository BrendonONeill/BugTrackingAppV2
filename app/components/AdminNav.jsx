  ...
  return (
    ...
    <nav className={mobileNav? "mobile-nav mn-open" : "mobile-nav mn-close"}>
        ...
        <ul>
            ...
            <li>
            <Link prefetch={true} className='nav-link' href={{pathname: '/users'}} replace><img src="/users.svg" width={20} height={20} alt="" /> View Users</Link>
            </li>
            <li>
            <Link prefetch={true} className='nav-link' href={{pathname: '/users/create'}} replace><img src="/createuser.svg" width={20} height={20} alt="" /> Create Users</Link>
            </li>
            
            <li>
            <Link prefetch={true} className='nav-link' as='/bugs' href='/bugs' ><img src="/buglist.svg" width={20} height={20} alt="" /> View Bugs</Link>
            </li>
            <li>
            <Link prefetch={true} className='nav-link' href={{pathname: '/bugs/create'}} replace><img src="/create.svg" width={20} height={20} alt="" /> Create Bugs</Link>
            </li>
            <li>
